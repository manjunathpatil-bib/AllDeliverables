...
'Description     - Advanced Tire Search script
'Created By      -
'Created On      -
'Modified By     -
'Modified On     -
...
For i = 1 To RowCount
	...
	If RunTest = "Yes" Then
		...
		'Position = Datatable.Value("Position","Sheet1")
		'LoadRange = Datatable.Value("LoadRange","Sheet1")
		...
		'Browser("Products").Page("Products").WebList("selectPosition").Select Position
		wait 1
		'Browser("Products").Page("Products").WebList("selectLoadRange").Select LoadRange
		wait 1
