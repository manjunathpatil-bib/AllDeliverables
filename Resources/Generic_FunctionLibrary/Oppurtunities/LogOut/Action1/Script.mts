...
environment.value("varpath") = Mid(scriptpath,1,Instrrev(Mid(scriptpath,1,Instrrev(Mid(scriptpath,1,instrrev(scriptpath,"\")-1),"\"))),"\")
Repositoriescollection.Add environment.value("varpath")&"ObjectRepository\Oppurtunities\LogOut.tsr"
